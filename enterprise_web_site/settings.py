"""
Django settings for enterprise_web_site project.
...
WSGI_APPLICATION = 'enterprise_web_site.wsgi.application'
...
# channels
ASGI_APPLICATION = "enterprise_web_site.routing.application"
